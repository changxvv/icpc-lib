 ...
 * License: CC0
 * Source:
 * Description: $C: \text{counter\_clockwise(C[0] == C[N])}, N\ge 3$. return highest point in $C\leftarrow P(\text{clockwise})$ or $-1$ if strictly in $P$. Polygon is strongly convex, $C[i]\neq P$
 * Status: Untested
 */
#pragma once
